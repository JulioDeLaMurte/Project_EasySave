...
namespace SaveModel
{
    ...
    abstract class Save_M
    {
        ...
        protected static bool sizeFlag { get; set; }
        ...
        public int getSizeFileLimit()
        {
         
            JToken jtokenExt = jsonObject.SelectToken("fileSizeMax");
            int intLimitSize = Convert.ToInt32(jtokenExt);
